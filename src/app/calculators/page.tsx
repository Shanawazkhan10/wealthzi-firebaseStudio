          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xs md:text-sm text-foreground text-right mt-1">(₹1,000 to ₹5 Cr)</p>
              </div>
              <div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <Slider value={[targetAmount]} onValueChange={(v) => setTargetAmount(v[0])} min={10000} max={100000000} step={10000} className="mt-2" />
                 <p className="text-xs md:text-sm text-foreground text-right mt-1">(₹10,000 to ₹10 Cr)</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xs md:text-sm text-foreground text-right mt-1">(₹5,000 to ₹1 Cr)</p>
              </div>
              <div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <Slider value={[monthlyDeposit]} onValueChange={(v) => setMonthlyDeposit(v[0])} min={500} max={100000} step={500} className="mt-2" />
                 <p className="text-xs md:text-sm text-foreground text-right mt-1">(₹500 to ₹1 Lac)</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xs md:text-sm text-foreground text-right mt-1">(₹50,000 to ₹2 Cr)</p>
              </div>
              <div>
