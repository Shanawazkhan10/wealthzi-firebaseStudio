      ...
      <div className="container mx-auto">
        <Card className="shadow-lg">
          ...
          <CardContent className="prose prose-sm md:prose-base max-w-none text-foreground">
            <p className="font-semibold">LimeWealth Investment Advisers (A division of Lime Internet Private Limited)</p>
            <p>[CIN: U74999DL2017PTC310507] [PAN: AADCL2103M] [GSTIN: 07AADCL2103M1ZP]</p>
            <p>
              [SEBI Registered Name: Lime Internet Private Limited] [SEBI RIA Registration No: INA000018133] [BASL Member ID: 2014] [Type of Registration: Non-Individual] [Validity of Registration: Perpetual] [Registered Address: Flat No. 603, 6th Floor, Kanchenjunga Building, 18 Barakhamba Road, New Delhi – 110001] [Principal Officer: Jyoti Prakash Nayak, Email: jyoti.prakash@LimeWealth.com] [Compliance Officer: Harshit Singh, Email: harshit.singh@LimeWealth.com] [Grievance Officer: Sanjeev Johari, Email: sanjeev.johari@nivesh.com]
            </p>
            <p>
