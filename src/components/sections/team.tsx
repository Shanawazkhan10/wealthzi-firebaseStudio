...
export default function Team() {
  return (
    <section
      id="about"
      className="relative py-16 lg:py-24 bg-[url(/moneyBackground.jpeg)] bg-cover bg-center bg-no-repeat"
    >
      <div className="container mx-auto relative space-y-16">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-foreground leading-relaxed">
            Our team combines decades of wealth management and technology
            experience to empower your financial journey.
          </p>
        </div>
        ...
        <div className="hidden md:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {teamMembers.map((member) => (
            <Card
              key={member.name}
              className="relative overflow-hidden rounded-xl shadow-lg group text-white border-none"
            >
              <Image
                src={member.image}
        ...
        <div className="pt-8">
              ...
              <CardContent className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-primary-foreground/80 text-base md:text-lg leading-relaxed">
                    Team with decades of wealth management and technology
                    experience in managing ₹2,500 crore worth assets of 1000+
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 mt-8">
            {reviewsArray.map((item, index) => (
              <Card
                key={index}
                className="bg-blue-100/50 backdrop-blur-sm border-blue-200 rounded-xl"
              >
