...
const faqData = [
  ...
  },
  {
    ...
    subTitle:
      'Minimum SIP amount varies from fund to fund, you can start as low as ₹100 in some of the funds.',
  },
  {
