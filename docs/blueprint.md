...
- Primary color: Deep blue (#194881) to convey trust and professionalism, relating to the core mission of the site.
- Background color: Very light blue (#F0F8FF) to create a clean and trustworthy backdrop.
- Accent color: Gold (#D4AF37) to highlight important calls to action and stats.
- Headline font: 'Inter' sans-serif for a clean and modern look. Body font: 'PT Sans' sans-serif for readability. 
- Professional and clean financial icons used throughout the website to visually represent services and information.
- Mobile-first responsive grid layout to ensure optimal viewing experience across all devices.
- Subtle fade transitions and animations for a smooth and engaging user experience.